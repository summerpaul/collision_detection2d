 ...
 * @Last Modified time: 2024-11-26 11:02:18
 */
 ...
 * @return CD_INLINE
 */
  CD_INLINE CD_RET cd_create_aabb(const CD_VEC2 *center, CD_F32 length,
                                  CD_F32 width, CD_AABB *result)
  {
    CD_RET ret = CD_RET_OK;
    CD_CHECK_ERROR(center == CD_NULL || result == CD_NULL,
  ...
  CD_INLINE CD_RET cd_aabb_contains(const CD_AABB *a, const CD_AABB *b,
                                    CD_BOOL *result)
  {
    CD_RET ret = CD_RET_OK;
    CD_CHECK_ERROR(a == CD_NULL || b == CD_NULL || result == CD_NULL,
                   COLLISION_DETECTION_E_PARAM_NULL);
    *result = (a->lowerBound.x <= b->lowerBound.x &&
 ...
 * @return CD_INLINE
 */
  CD_INLINE CD_RET cd_aabb_overlap(const CD_AABB *a, const CD_AABB *b,
                                   CD_BOOL *result)
  {
    CD_RET ret = CD_RET_OK;
    CD_CHECK_ERROR(a == CD_NULL || b == CD_NULL || result == CD_NULL,
                   COLLISION_DETECTION_E_PARAM_NULL);
    *result = (a->lowerBound.x <= b->upperBound.x &&
  ...
  {
    CD_RET ret = CD_RET_OK;
    CD_CHECK_ERROR(a == CD_NULL || result == CD_NULL,
                   COLLISION_DETECTION_E_PARAM_NULL);
  ...
  CD_INLINE CD_RET cd_aabb_union(const CD_AABB *a, const CD_AABB *b,
                                 CD_AABB *result)
  {
    CD_RET ret = CD_RET_OK;
    CD_CHECK_ERROR(a == CD_NULL || b == CD_NULL || result == CD_NULL,
  ...
  CD_INLINE CD_RET cd_is_point_in_aabb(const CD_AABB *a, const CD_VEC2 *point,
                                       CD_BOOL *result)
  {
    CD_RET ret = CD_RET_OK;
    CD_CHECK_ERROR(a == CD_NULL || point == CD_NULL || result == CD_NULL,
                   COLLISION_DETECTION_E_PARAM_NULL);
